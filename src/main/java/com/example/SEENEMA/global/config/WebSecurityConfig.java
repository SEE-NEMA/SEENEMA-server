...
import com.example.SEENEMA.global.jwt.JwtAuthenticationFilter;
...
//                .antMatchers("/api/v1/test/**").hasRole("USER");
        http
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/theater-review/auth").permitAll()
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/theater-review/{postNo}/auth").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/theater-review/{postNo}/{commentId}/auth").permitAll()
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/view-review/auth").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/view-reivew/{theaterId}/{viewNo}/auth").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/api/v1/user/profile").authenticated()
                .antMatchers(HttpMethod.PUT, "/api/v1/user/profile").authenticated()
                .antMatchers(HttpMethod.POST, "/api/v1/user/profile/check-nickname").authenticated()
                .antMatchers(HttpMethod.GET, "/api/v1/user/my-review/theater").authenticated()
                .antMatchers(HttpMethod.GET, "/api/v1/user/my-review/theater/comment").authenticated()
                .antMatchers(HttpMethod.GET, "/api/v1/user/my-review/view").authenticated()
                .antMatchers(HttpMethod.GET, "/api/v1/user/my-heart/theater").authenticated()
                .antMatchers(HttpMethod.GET, "/api/v1/user/my-heart/view").authenticated()
