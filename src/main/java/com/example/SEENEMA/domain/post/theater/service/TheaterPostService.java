package com.example.SEENEMA.domain.post.theater.service;

import com.example.SEENEMA.domain.post.comment.dto.CommentDto;
...
public interface TheaterPostService {
    ...
    List<TheaterPostDto.listResponse> listTheaterPostByTags(List<Long> tagIds);
    ...
    TheaterPostDto.addResponse cancelHeart(Long userId, Long postNo);
}
